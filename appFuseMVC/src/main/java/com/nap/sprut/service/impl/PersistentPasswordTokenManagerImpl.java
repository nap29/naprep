...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.nap.sprut.service.impl.PasswordTokenManager#generateRecoveryToken(com.nap.sprut.model.User)
     */
    @Override
    ...
    /**
     * @see com.nap.sprut.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.nap.sprut.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.nap.sprut.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
